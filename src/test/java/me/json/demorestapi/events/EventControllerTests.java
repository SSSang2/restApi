...
import me.json.demorestapi.events.common.RestDocsConfiguration;
...
public class EventControllerTests {
    ...
    public void updatEvent() throws Exception{
        //Given
    ...
    public void updatEvent400_Empty() throws Exception{
        //Given
        Event event = this.generateEvent(200);
    ...
    public void updatEvent400_Wrong() throws Exception{
        //Given
        Event event = this.generateEvent(200);
    ...
    public void updatEvent404() throws Exception{
        ...
        //When & Then
        this.mockMvc.perform(put("/api/events/132311")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isNotFound())
